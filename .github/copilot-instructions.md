...
It contains 17 experiment modules (00–16) covering GT SFT baseline, white-box/black-box/cross-architecture teacher distillation, multi-teacher fusion, rationale distillation, and full-data scaling.
