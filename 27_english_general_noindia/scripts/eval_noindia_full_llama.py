#!/usr/bin/env python3
"""27 英文全科·无印度评估（第二名学生 Llama-3.3-70B）：学生+adapter vs 弱教师(Qwen3-32B 零样本)。
...
ADAPTER = "runs/Llama70B_noindia_a00_s42"
...
def main():
    # 学生（Llama-70B + adapter，4bit）
    print("[学生] 加载 Llama-3.3-70B(4bit) + adapter ...", flush=True)
    ...
    print("\n=== 英文全科·无印度：学生(Llama-70B) vs 弱教师 ===", flush=True)
    d = round(s - t, 2)
